...
class ChefTest < ActiveSupport::TestCase
  ...
  def setup
    @chef = Chef.new(chefname: "Nick Laux", email: "nlaux@protojet.com")
  end
  ...
  test "email validation should accept valid emails" do
    valid_addresses = %w[user@eee.com R_TDD-DS@eee.hello.org user@example.com first.last@eee.com laura+joe@monk.com]
